...
// rsk_find_events
Rcpp::List rsk_find_events(const Rcpp::RawVector x, const size_t header_length);
...
Rcpp::IntegerVector rsk_incomplete_events(const Rcpp::IntegerVector x, const Rcpp::IntegerVector times, const size_t n_cols, const bool f5);
static SEXP _rsk_rsk_incomplete_events_try(SEXP xSEXP, SEXP timesSEXP, SEXP n_colsSEXP, SEXP f5SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< const Rcpp::IntegerVector >::type x(xSEXP);
    Rcpp::traits::input_parameter< const Rcpp::IntegerVector >::type times(timesSEXP);
    Rcpp::traits::input_parameter< const size_t >::type n_cols(n_colsSEXP);
    Rcpp::traits::input_parameter< const bool >::type f5(f5SEXP);
    rcpp_result_gen = Rcpp::wrap(rsk_incomplete_events(x, times, n_cols, f5));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _rsk_rsk_incomplete_events(SEXP xSEXP, SEXP timesSEXP, SEXP n_colsSEXP, SEXP f5SEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_rsk_rsk_incomplete_events_try(xSEXP, timesSEXP, n_colsSEXP, f5SEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _rsk_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("Rcpp::List(*rsk_find_events)(const Rcpp::RawVector,const size_t)");
        signatures.insert("Rcpp::IntegerVector(*rsk_incomplete_events)(const Rcpp::IntegerVector,const Rcpp::IntegerVector,const size_t,const bool)");
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rsk_rsk_incomplete_events", (DL_FUNC) &_rsk_rsk_incomplete_events, 4},
